...
public class TestDoubleLinkedList extends BaseTest {
    ...
    public void testDeleteFromEnd() {
        ...
        assertEquals(cap, list2.size());
        for (int i = cap - 1; i >= 0; i--) {
            int value = list2.delete(i);
            assertEquals(i, value);            
        }
    ...
    @Test(timeout=SECOND)
    public void testDeleteOutOfBoundsException() {
        IList<String> list = this.makeBasicList();
        try {
            list.delete(-1);
            fail("Expected IndexOutOfBoundsException");
    ...
    @Test(timeout=SECOND)
    public void testInsertAndDeleteFromEndEfficiency() {
        IList<String> list = new DoubleLinkedList<>();
        int max = 1000000;
        for (int i = 0; i < max; i++) {
            list.insert(0, "" + i);
    ...
    @Test(timeout=SECOND)
    public void testInsertAndDeleteFromFrontEfficiency() {
        IList<String> list = new DoubleLinkedList<>();
        int max = 1000000;
        for (int i = 0; i < max; i++) {
            list.insert(0,  "" + i);
